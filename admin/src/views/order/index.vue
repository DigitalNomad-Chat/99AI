  ...
  <div>
    ...
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline" class="mb-4">
        ...
        <el-form-item>
          ...
          <el-popconfirm title="确认删除所有未支付订单么?" @confirm="handleDelNotPayOrder">
            <template #reference>
    ...
    <page-main style="width: 100%">
      ...
      >
        ...
        <el-table-column prop="count" label="购买数量" width="90" align="center" />
        <el-table-column prop="total" label="订单总价" width="90" align="center" />
        <el-table-column prop="total" label="支付平台" width="90" align="center">
          <template #default="scope">
            {{ PAY_PLATFORM_MAP[scope.row.payPlatform as PayPlatform] }}
          </template>
        </el-table-column>
        <el-table-column prop="status" label="支付状态" width="90" align="center">
          <template #default="scope">
        ...
        <el-table-column prop="createdAt" label="订单时间" width="200" fixed="right">
          <template #default="scope">
